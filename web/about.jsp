...
<body>
    ...
    <div class="about">
        ...
        <div class="right-panel">
            <h1>About Medix</h1>
            <p>Medix is a complete health guide website which includes diet and fitness, A-Z healthcare, diseases, pregnancy, and beauty health related information. <br><br> Medix inspires and empowers people to live their healthies lives, through trusted, medically reviewed information and expert's advice on various health subjects.</p>
        </div>
    </div>
