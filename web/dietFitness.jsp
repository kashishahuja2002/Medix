<html>
    <head>
        <title>Medix | Diet and Fitness</title>
...
<body>
    ...
    <div class="about">
        ...
        <div class="right-panel">
            <h1>Diet and Fitness</h1>
            <p>A complete fitness guide including exercise & daily workouts for men, women & kids, diet plans & nutrition, yoga poses & medication, and cardio exercise.</p>
            <ul class="blog-link">
                <li><a href="blog.jsp">Weight Management</a></li>
                <li><a href="blog.jsp">Exercise and Body Building</a></li>
                <li><a href="blog.jsp">Diet and Recipes</a></li>
                <li><a href="blog.jsp">Yoga</a></li>
            </ul>
        </div>
    </div>
