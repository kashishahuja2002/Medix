<html>
    <head>
        <title>Medix | Beauty Health</title>
...
<body>
    ...
    <div class="about">
        ...
        <div class="right-panel">
            <h1>Beauty Health</h1>
            <p>A Complete Guide on beauty health, skin care, hair Care, body care, DIY, and the latest age rejuvenation techniques.</p>
            <ul class="blog-link">
                <li><a href="blog.jsp">Skin Care</a></li>
                <li><a href="blog.jsp">Hair</a></li>
                <li><a href="blog.jsp">Grooming</a></li>
            </ul>
        </div>
    </div>
