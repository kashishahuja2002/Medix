...
<!-- <a href="sessionDestroy.jsp">logout</a> -->

<html>
    <head>
        <title>Medix | Operator</title>
...
<body>
    ...
    <div class="sub-header">
        <ul>
            ...
            <li><a href="expertSignup.jsp" class="be-an-expert">Be an Expert</a></li>
            <li><a href="profile.jsp" class="profile">Profile</a></li>
            <li><a href="sessionDestroy.jsp" class="logout">Logout</a></li>
        </ul>
    </div>
    ...
    <!-- Image banner -->
    <div class="banner">
        <img src="./assets/images/banner.jpg" alt="" width="100%" height="40%">
    </div>
    ...
    <div class="services">
        ...
        <div class="box">
            <a href="dietFitness.jsp">
                <img src="./assets/images/fitness.jpg" alt="">
                <figcaption>Diet and Fitness</figcaption>
            </a>
        </div>
        <div class="box">
            <a href="healthA-Z.jsp">
                <img src="./assets/images/heallth a-z.jpg" alt="">
                <figcaption>Health A-Z</figcaption>
            </a>
        </div>
        <div class="box">
            <a href="experts.jsp">
                <img src="./assets/images/expert.jpg" alt="">
                <figcaption>Talk to our Experts</figcaption>
            </a>
        </div>
        <div class="box">
            <a href="pregnancy.jsp">
                <img src="./assets/images/pregnancy.jpg" alt="">
                <figcaption>Pregnancy</figcaption>
            </a>
        </div>
        <div class="box">
            <a href="beautyHealth.jsp">
                <img src="./assets/images/beauty health.jpg" alt="">
                <figcaption>Beauty Health</figcaption>
            </a>
        </div>
        <br> 
        <button href="services.jsp">Know more</button>
    </div>
